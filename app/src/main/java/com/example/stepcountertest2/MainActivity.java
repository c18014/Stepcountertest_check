package com.example.stepcountertest2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] sensorList={
            ...
            Sensor.TYPE_MOTION_DETECT, Sensor.TYPE_POSE_6DOF,
            Sensor.TYPE_PRESSURE, Sensor.TYPE_PROXIMITY,
            Sensor.TYPE_RELATIVE_HUMIDITY, Sensor.TYPE_ROTATION_VECTOR,
            Sensor.TYPE_SIGNIFICANT_MOTION, Sensor.TYPE_STATIONARY_DETECT,
    ...
    private String[] sensorNameList = {
            ...
            "HEART_RATE", "LIGHT", "LINEAR_ACCELERATION", "LOW_LATENCY_OFFBODY_DETECT",
